# VÄRLDENS LORE: SLOTTET EALDROR

## RUM_01_KÄLLARE
**Namn:** Källaren
**Beskrivning:** Du står på en avsats som är en meter bred och ligger fem meter ovanför en stor källare. Stentrappor leder ner till golvet. En stencistern upptar den västra delen av rummet, kantad med tunnor fyllda med saltat fläsk och mjöl. I väster finns en låst trädörr.
...
## RUM_02_BARACKER
**Namn:** Baracker (Förråd)
**Beskrivning:** Detta verkar vara ett förråd som har tagits i bruk som bostadsutrymme. Två dubbla våningssängar står längs väggen nära dörren, medan tunnor och lådor fyller den södra halvan av rummet. I ena hörnet av rummet finns ett kort blodigt svärd. 
**Dolda Detaljer:** Inga
...
## RUM_03_KORRIDOR
**Namn:** Korridor
**Beskrivning:** Tjockt damm täcker stenplattorna i denna dystra korridor. Väggarna är dekorerade med falska pelare var tionde fot, och dubbeldörrarna i korridorens västra ände är klädda i kopparplåt som nu har blivit grön av ålder. En reliefskulptur av en sorgsen ängel pryder dörrarna
**Dolda Detaljer:** Inga
...
## RUM_05_SLAVKAMMARE
**Namn:** Slavkammare
**Beskrivning:** Detta långa rum är uppdelat i tre områden, med järnstänger som skiljer av norr och söder. Smutsigt halm täcker golven i dessa celler, vars gångjärnsförsedda dörrar är säkrade med kedjor och hänglås. Två döda ovårdade mänskliga kvinnor finns i cellen i söder, medan en mänsklig pojke hittas i norr. Alla är klädda i enkla grå tunikor och har järnhalsband runt sina halsar.
En hög med övergivna kläder ligger slarvigt hopkastad mot den bortre väggen.
**Dolda Detaljer:** 
**Fiender:** Inga
